...
namespace _2023_GC_A2_Partiel_POO.Level_2
{
    ...
    public class TypeResolver
    {
        ...
        {
            if ((attacker == TYPE.WATER && receiver == TYPE.FIRE) || (attacker == TYPE.FIRE && receiver == TYPE.GRASS) || (attacker == TYPE.GRASS && receiver == TYPE.WATER))
            {
                return 1.2f;
            }
            if ((attacker == TYPE.WATER && receiver == TYPE.GRASS) || (attacker == TYPE.GRASS && receiver == TYPE.FIRE) || (attacker == TYPE.FIRE && receiver == TYPE.WATER))
            {
                return 0.8f;
            }
